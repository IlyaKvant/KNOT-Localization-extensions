...
```
https://github.com/KefirBox/KNOT-Localization-extensions.git#1.0.1
```

or by adding

```
"com.kefirbox.knotlocalizationextensions": "https://github.com/KefirBox/KNOT-Localization-extensions.git#1.0.1"
```
